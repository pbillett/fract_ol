...
/*   Updated: 2017/01/19 17:08:16 by pbillett         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_wind *w)
{
	r_angle.x = ft_degree_to_radian(angle.x);
	r_angle.y = ft_degree_to_radian(angle.y);
	r_angle.z = ft_degree_to_radian(angle.z);
